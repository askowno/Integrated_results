...
<https://github.com/SANBI-TER-ECO/RLE_terr/blob/main/outputs/ter_results_for_integration.csv>
...
ter_results <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/RLE_terr/main/outputs/ter_results_for_integration.csv") %>% mutate(RLE = factor(RLE, levels = c("CR", "EN", "VU", "LC"), ordered = TRUE), EPL = factor(EPL, levels = c("WP", "MP", "PP", "NP"), ordered = TRUE)) 

riv_results <- read.csv("https://raw.githubusercontent.com/askowno/RLE_riv/main/outputs/riv_results_for_integration.csv")  %>% mutate(RLE = factor(RLE, levels = c("CR", "EN", "VU", "LC"), ordered = TRUE), EPL = factor(EPL, levels = c("WP", "MP", "PP", "NP"), ordered = TRUE)) 

wet_results <- read.csv("https://raw.githubusercontent.com/askowno/RLE_wet/main/outputs/wet_results_for_integration.csv")  %>% mutate(RLE = factor(RLE, levels = c("CR", "EN", "VU", "LC"), ordered = TRUE), EPL = factor(EPL, levels = c("WP", "MP", "PP", "NP"), ordered = TRUE)) 

est_results <- read.csv("https://raw.githubusercontent.com/askowno/RLE_est/main/outputs/est_results_for_integration.csv")  %>% mutate(RLE = factor(RLE, levels = c("CR", "EN", "VU", "LC"), ordered = TRUE), EPL = factor(EPL, levels = c("WP", "MP", "PP", "NP"), ordered = TRUE)) 
...
Make Plots for Headline Indicator figure (3) in website (for booklet drop legend and make 7x7
