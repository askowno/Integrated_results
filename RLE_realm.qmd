...
rle_count_coa <- filter(nba18rlecount, realm == "coa")

  
rle_ext_sub <- filter(nba18rleext, realm == "sub")
rle_ext_coa <- filter(nba18rleext, realm == "coa")
...
rle_count_zones <- bind_rows(rle_count_ter, rle_count_riv, rle_count_wet, rle_count_mar, rle_count_est)
...
rle_count_tot <- rle_count_zones %>%
  ...
  bind_rows(rle_count_coa, rle_count_sub)
...
# Write to file
write.csv(rle_count_tot, "C:/Rdata/plot_export/outputs/rle_count_per_realm.csv")
```
...
# BIND tables of RLE count together
rle_ext_zones <- bind_rows(rle_ext_ter, rle_ext_riv, rle_ext_wet, rle_ext_est, rle_ext_mar)
...
rle_ext_tot <- rle_ext_zones %>%
  ...
  bind_rows(rle_ext_coa,rle_ext_sub )
...
# Write to file
write.csv(rle_ext_tot, "C:/Rdata/plot_export/outputs/rle_ext_per_realm.csv")
```
